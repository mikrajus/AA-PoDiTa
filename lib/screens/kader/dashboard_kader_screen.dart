...
class _DashboardKaderScreenState extends State<DashboardKaderScreen> {
                ...
                Expanded(child: Column(
                  ...
                  Text(
                    widget.namaKader.isEmpty
                        ? 'Kader Posyandu' : 'Halo, ${widget.namaKader}',
                    style: GoogleFonts.poppins(
                        fontSize: 15, fontWeight: FontWeight.w700,
  ...
  Widget _buildKalkulatorCard() => GestureDetector(
    onTap: () => Navigator.push(context,
        MaterialPageRoute(builder: (_) => const KalkulatorStuntingScreen())),
    child: Container(
  ...
  Widget _buildDataBayiCard(BayiService svc) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        Text('Data Bayi', style: GoogleFonts.poppins(
            fontSize: 15, fontWeight: FontWeight.w700,
            color: AppColors.textDark)),
        if (svc.dataBayi.isNotEmpty)
          Text('${svc.totalBayi} bayi', style: GoogleFonts.poppins(
              fontSize: 12, color: AppColors.textMedium)),
      ]),
      const SizedBox(height: 10),
      if (svc.dataBayi.isEmpty)
        Container(
          width: double.infinity,
        ...
        ...svc.dataBayi.map((bayi) {
          final isStunting = bayi.statusStunting.toLowerCase().contains('stunting');
          final statusColor = isStunting
              ? const Color(0xFFE57373) : AppColors.success;
          return GestureDetector(
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (_) => DetailBayiScreen(bayi: bayi))).then((_) => setState(() {}));
            },
            child: Container(
              ...
              child: Row(children: [
                ...
                Expanded(child: Column(
                  ...
                  Text(bayi.namaBayi, style: GoogleFonts.poppins(
                      ...
                      color: AppColors.textDark)),
                  Text('${bayi.umurBulan} bulan · Ibu: ${bayi.namaIbu}',
                      style: GoogleFonts.poppins(
                          fontSize: 11, color: AppColors.textMedium)),
                ])),
                Container(
