...
class _DaftarKepalaScreenState extends State<DaftarKepalaScreen> {
  ...
  @override
  void dispose() {
    _usernameCtrl.dispose(); _namaCtrl.dispose();
    _passwordCtrl.dispose(); _confirmCtrl.dispose();
    _nikCtrl.dispose();      _hpCtrl.dispose();
    super.dispose();
  }
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Text('Akun Kepala Puskesmas Anda telah dibuat. Silakan masuk.',
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
                ...
                child: Row(children: [
                  ...
                  Expanded(
                    child: Text(
                      ...
                      style: GoogleFonts.poppins(
                          fontSize: 12, color: AppColors.blueDark, height: 1.5),
                    ),
                  ),
                ]),
              ),
              ...
              _SectionLabel(label: 'Data Akun', icon: Icons.manage_accounts_rounded),
              ...
              CustomTextField(
                ...
                validator: (v) {
                  if (v == null || v.isEmpty) return 'Konfirmasi password wajib';
              ...
              _SectionLabel(label: 'Data Identitas', icon: Icons.credit_card_rounded),
              const SizedBox(height: 14),
...
class _SectionLabel extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Row(children: [
    ...
    Text(label, style: GoogleFonts.poppins(
        ...
        color: AppColors.textMedium, letterSpacing: 0.4)),
  ]);
}
